...
function App() {
  ...
  // A landing page, onboarding wizard, mapa de prestadores, páginas de provider, página de autenticação e página de teste de agendamento inteligente precisam ter largura total
