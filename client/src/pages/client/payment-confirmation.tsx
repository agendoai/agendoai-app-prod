// Página de confirmação após o processamento do pagamento
  ...
  useEffect(() => {
    ...
    if (redirectStatus === 'succeeded') {
      ...
      toast({
        ...
        description: "Seu pagamento está sendo processado. Atualizaremos você assim que for concluído.",
      });
    } else {
      setStatus('failed');
      toast({
        title: "Falha no pagamento",
        description: "Ocorreu um problema com seu pagamento. Por favor, tente novamente.",
        variant: "destructive",
      });
    }
        ...
        {isLoading ? (
          <Card>
            <CardContent className="py-10 flex items-center justify-center">
              ...
              <span className="ml-2">Verificando status do pagamento...</span>
            </CardContent>
          </Card>
        ) : status === 'success' ? (
          <Card>
          ...
          <Card>
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-center text-2xl">Pagamento em Processamento</CardTitle>
              <CardDescription className="text-center">
            ...
            <CardContent className="pt-0 space-y-4">
              <div className="rounded-lg bg-yellow-50 p-4 text-yellow-800">
                ...
                <ul className="mt-2 list-disc list-inside text-sm">
                  ...
                  <li>Não é necessário refazer o pagamento</li>
                </ul>
              </div>
          ...
          <Card>
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-center text-2xl">Falha no Pagamento</CardTitle>
              <CardDescription className="text-center">
