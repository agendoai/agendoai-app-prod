...
import { BarChart4, Calendar, DollarSign, ClipboardList, CreditCard, Banknote, ArrowDownToLine, CheckCircle, AlertCircle, XCircle } from "lucide-react";
...
export default function AnalyticsPage() {
  ...
  const handleWithdrawalSubmit = () => {
    ...
    // Check if today is Wednesday and if user already made a request this Wednesday
    const today = new Date();
    ...
    if (!isWednesday) {
      toast({
        ...
        description: `Saques só podem ser solicitados às quartas-feiras. Próxima data disponível: ${getNextWednesday()}.`,
        variant: "destructive",
      });
      return;
    }
    ...
    if (hasRequestThisWednesday) {
      toast({
        title: "Saque já solicitado",
        description: "Você já fez uma solicitação de saque nesta quarta-feira.",
        variant: "destructive",
      });
      return;
    }
