...
import { Bell, Check, CheckCircle, Clock, Info, AlertTriangle, ArrowLeft } from "lucide-react";
    ...
    <ProviderLayout>
      <div className="min-h-screen w-full bg-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          {/* Header */}
          <header className="bg-gradient-to-r from-[#58c9d1] to-[#4aadb5] text-white py-0 shadow-lg rounded-xl mb-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <Button 
                    ...
                    variant="ghost" 
                    size="sm"
                    className="p-2 bg-white/20 hover:bg-white/30 text-white mr-2"
                  >
